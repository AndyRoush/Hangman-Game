// global variables
var wordList = ['freshprince', 'friends', 'seinfeld', 'fullhouse', 'familymatters', 'savedbythebell',
'homeimprovement', 'dinosaurs', 'martin', 'rockosmodernlife', 'boymeetsworld', 'doug', 'roseanne', 'inlivingcolor',
'animaniacs', ];
   ...
   */
   ...
   function checkLetters(letter){
       ...
       2. Determine if the letter the user picked
   ...
   function roundComplete(){
       /*
       1. Will update the HTML with letters that are in the word
       2. Is going to update the HTML with guesses we have left
       3. Is going to update the HTML to show the wrong guesses
       4. Is going to determine whether the use won the game or not
       */
       ...
       if(lettersInChosenWord.join(" ") === blanksAndSuccesses.join(" ")){
           winCounter++;
        //    alert("Congrats you 90s master!");
           document.getElementById("winimg").src = "../images/cup.jpg"; //Not working right now.
